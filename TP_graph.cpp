...
class Graph
{
    ...
    void addVertex(const std::string &name, int index)
    {
        ...
        else
        {
            ...
            std::cout << "Le sommet " << name <<" a bien été ajouté"<< std::endl;
        }
    }
    ...
    void add_edge(int id1, int id2, double w) // crée une arrête orientée id1 -> id2
    {
        ...
        if ((check1 && check2) == true)
        {
            ...
            else
            {
                ...
                std::cout << "Arête bien ajoutée" << std::endl;
            }
        }
        else
        {
